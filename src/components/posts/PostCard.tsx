              ...
              <Carousel className="w-full" opts={{ direction: 'rtl' }}>
                <CarouselContent>
                  {post.mediaUrls.map((url, i) => (
                    <CarouselItem key={i}><div className="rounded-xl overflow-hidden border bg-muted/5 aspect-square relative"><img src={url} alt="Media" className="absolute inset-0 w-full h-full object-cover" /></div></CarouselItem>
                  ))}
                </CarouselContent>
