...
export default function PostCard({ post }: { post: PostData }) {
  ...
  return (
    <Card className="border-none shadow-none rounded-none w-full bg-card mb-[1px] last:mb-0 transition-colors hover:bg-muted/5">
      ...
      <CardFooter className="px-1 py-1 border-t-0 flex justify-around items-center h-9">
        ...
        <Button variant="ghost" size="sm" className="h-8 flex-1 text-muted-foreground rounded-none">
          <Share2 size={16} />
        </Button>
      </CardFooter>
    </Card>
